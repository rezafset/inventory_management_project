        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar Search -->
                    <h1 class="h3 mb-0 text-gray-800">Product Details Page</h1>
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-3 text-gray-800 text-center">Product Information</h1>
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-6">
                                 ...
                                 <div class="col-md-6">
                                    ...
                                    <a href="updateProduct.php?id=<?php echo $result['id'] ?>"><button type="button" class="btn btn-info">Update</button></a>
                                    <a href="deleteProduct.php?id=<?php echo $result['id'] ?>"><button type="button" class="btn btn-danger">Delete</button></a>
